...
<img src="p8105_hw5_sc4636_files/figure-gfm/power plot-1.png" width="90%" />

From the above graph, it can be observed that as effect size increases,
power would increase as well. When the effect size is 1, the power of
the study is around 0.12. When the effect size is equal or larger than
4, the power is nearly more than 0.80.
